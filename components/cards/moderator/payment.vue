<template>
  <div class="card tender-card">
    <div class="card-header">
      ...
      >
        {{
          ...
          data.customStatus.title[$i18n.locale]
        }}
      </small>
    </div>
    <div class="card-body">
      ...
      <h3 class="text-body1 black1">
        {{ data.organizer && data.organizer.organization_name }}
      </h3>
    </div>
    <div class="card-footer">
      ...
      <nuxt-link :to="{ path: `/cabinet/moderator/tenders/detail/${data.id}` }"
        >Batafsil <i class="icon-angle-right"></i
      ></nuxt-link>
    </div>
  </div>
</template>
