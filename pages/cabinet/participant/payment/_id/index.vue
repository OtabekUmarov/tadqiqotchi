        ...
        <div class="border-bottom mb-24">
          <a-row type="flex" :gutter="[24,12]">
            ...
            <a-col span="8">
              ...
              <h3 class="text-body1 black1">{{detail.operator_bank_code}}</h3>
            </a-col>
            <a-col span="8">
            ...
            <a-col span="8">
              ...
              <h3 class="text-body1 black1">Shaffof yol axborot markazi</h3>
            </a-col>
          </a-row>
        </div>
...
export default {
  ...
  computed: {
    ...mapGetters("participant/payment", ["detail", "loading"]),
    acc_number() {
  ...
  methods: {
    ...mapActions("participant/payment", ["getDetail"]),
    fetchDetail() {
